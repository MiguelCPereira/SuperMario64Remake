...
void MarioCharacter::Jump(bool crouched)
{
	...
	case 3:
		...
		break;
	case 4:
		//const auto newVelocity = XMLoadFloat3(&m_TotalVelocity) - XMLoadFloat3(&m_CurrentDirection) * m_CharacterDesc.BackFlipSpeedBack;
		//XMStoreFloat3(&m_TotalVelocity, newVelocity);
